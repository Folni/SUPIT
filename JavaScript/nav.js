        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
            <div class="container-fluid">
                <div class="prijava_container">
                    ...
                    <a class="nav-link" href="index.html" id="logout-link"> Odjava</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="Nastavniplan"  href="NastavniPlan.html">Nastavni plan</a>
                        </li>
                    </ul>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="formModalLabel">Contact Us</h5>
                ...
                <div class="modal-body">
                    ...
                    >
                        ...
                        <div class="mb-3">
                            ...
                            <select name="Importance" class="form-select" id="importance" required>
                                <option value="" selected disabled>Select importance level</option>
                        ...
                        <div class="form-check mb-3">
                            ...
                            <input class="form-check-input" name="RecieveNewsletter" type="checkbox" id="receiveNewsletter">
                        </div>
...
`;
  ...
  $(".sidebar-li").on("click", function (event) {
    event.preventDefault(); //skakanje na sekciju je sprijeceno
    ...
    if (targetElement) {
      ...
      //chat-gpt <koregiranje pozicije>
      const offset = 110;
      const targetPosition =
        targetElement.getBoundingClientRect().top + window.pageYOffset;
      //absolute position of element relative to entire document - 110
      window.scrollTo({
